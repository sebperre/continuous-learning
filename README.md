...
**What I learned:** I learned how to use Node.js such as how to run it, set it up, REST API theory, express, routes, middleware, thunder client, JWTs, route validation, deployment to Render
